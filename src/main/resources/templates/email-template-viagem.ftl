...
<body>
    ...
    <div style="background-color: #f2f2f2; padding: 20px; font-family:courier;">
        ...
        <br>${mensagem}
        <br>
        <br>O local de partida é: <b>${partidaRota}</b>
        <br>Com a data inicial da viagem em: <b>${inicioViagenm}</b>
        <br>O local do destino é: <b>${destinoRota}</b>
        <br>Com a data prevista para o encerramento em: <b>${fimViagem}</b>
